            ...
            <div class="col-12 col-lg-6 logIn-form px-5 px-lg-3 pt-0 pb-5 py-lg-0">
                ...
                <div class="col-12 px-5 px-lg-6 log-in-form-log d-flex flex-row-reverse flex-wrap">
                    ...
                    <div class="col-10 col-lg-9  px-0 px-lg-3 mt-5 mt-lg-4">
                        ...
                        <p class="mobile-login-register-txt mt-4 col-10 mx-auto ">عضو نشده اید؟؟</p>
                        <a
                            style="background-color: #d73b6a;color: white;border: none;border-radius: 5px;padding: 7px 20px !important;transition: 0.2s;text-align: center;"
