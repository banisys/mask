...
module.exports = {
	...
	modes: {
		...
		/**
		 * Point mode returns all elements that hit test2 based on the event position
		 * of the event
		...
		/**
		 * x mode returns the elements that hit-test2 at the current x coordinate
		...
		/**
		 * y mode returns the elements that hit-test2 at the current y coordinate
...
var helpers = {
	 ...
	 * @param {*} value - The value to test2.
	 * @returns {Boolean}
	 * @since 2.7.0
	 */
